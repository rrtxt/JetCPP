...
void GameSettingUIComponent::Draw() {
    ...
    DrawRectangle(0, 0, VIRTUAL_WIDTH, VIRTUAL_HEIGHT, backgroundColor);
...
void GameSettingUIComponent::DrawSettings() {
    settingsStartPosition.x = VIRTUAL_WIDTH / 2 - 200;
...
void GameSettingUIComponent::DrawBackButton() {
    Rectangle backButtonRect = {
        (float)(VIRTUAL_WIDTH / 2 - buttonWidth / 2),
        (float)(VIRTUAL_HEIGHT - 100),
        buttonWidth,
        buttonHeight
    };
